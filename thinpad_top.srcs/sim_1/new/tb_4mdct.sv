...
module tb;
  ...
  initial begin
    ...
    reset_btn = 0;
    #100;
    // dip_sw = 32'b11100001000100001010;
    #100;
    push_btn = 1;
    #100;
    push_btn = 0;
    ...
    #10000;
    uart.pc_send_byte(8'h80); //send addr = 0x80100080
    #10000;
    $display("send 80100080"); 
    ...
    uart.pc_send_byte(8'h00);
    #10000;
    uart.pc_send_byte(8'h00); //send num = 0x00000028
    $display("send 0x00000028");
    ...
    #10000;
    uart.pc_send_byte(8'h96);
    #10000;
    uart.pc_send_byte(8'h02);
    #10000;
    uart.pc_send_byte(8'hfe);
    #10000;
    $display("bne t0, zero, .LC3");
    ...
    uart.pc_send_byte(8'h00);
    #10000;
    uart.pc_send_byte(8'h00); //send addr = 0x00000080
    #10000;
    $display("send 00000080"); 
