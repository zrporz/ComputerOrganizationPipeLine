...
module tb;
  ...
  initial begin
    ...
    uart.pc_send_byte(8'h64);
    #10000;   
    uart.pc_send_byte(8'h00);
    #10000;
    uart.pc_send_byte(8'h10);
    #10000;
    uart.pc_send_byte(8'h80); //send addr = 0x80100064
    #10000;
    $display("send 80100064"); 
    ...
    uart.pc_send_byte(8'h00);
    #10000;
    uart.pc_send_byte(8'h00); //send num = 0x0000001c 
    $display("send 0x0000001c");
    ...
    uart.pc_send_byte(8'h00);
    #10000;
    uart.pc_send_byte(8'h00); //send addr = 0x00000064
    #10000;
    $display("send 00000064"); 
